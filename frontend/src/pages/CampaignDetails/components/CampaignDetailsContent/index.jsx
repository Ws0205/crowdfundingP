                ...
                >
                    ...
                    >
                        ...
                        <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                            <h4 className="font-epilogue font-semibold text-[14px] leading-[22px] text-white">Give hope and create change.</h4>
                            <p className="mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]">Join hands with us to create a better world through your support.</p>
                        </div>
                        <CustomButton
                            btnType="button"
                            title="Fund Campaign"
